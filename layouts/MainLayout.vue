<template>
  <div id="MainLayout" class="w-full fixed z-50">
    <div id="TopMenu" class="bd-[#FAFAFA] border-b md:block hidden">
      <ul
      ...
      >
        ...
        <li
          ...
          class="relative flex items-center ph-2.5 hover:text-[#ff4646] h-full cursor-pointer"
          :class="
            isAccountMenu
        ...
        >
          ...
          >
            <div v-if="!user">
              <div class="test-semibold text-[15px] my-4 px-3">
                Welcome to AlliExpress!
              </div>
          ...
          <div class="relative">
            ...
            <div class="absolute bg-white max-w-[700px] h-auto w-full">
              ...
              >
                <Nuxt-link
                  :to="`/item/${item.id}`"
                  class="flex items-center justify-between w-full cursor-pointer hower:bg-gray-100"
                >
